//! This app is intended to be used for testing against a fake-relay (https://github.com/ZanCorDX/fake-relay) without needing to have the builder or relay running.
